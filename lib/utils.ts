...
export const getTimestamp = (createdAt: Date): string => {
  ...
  const months = Math.floor(days / 30); // Approximation, considering a month as 30 days
  const years = Math.floor(days / 365); // Approximation, considering a year as 365 days
...
// Example usage
const createdAt = new Date("2022-01-01T12:00:00Z");
